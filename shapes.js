...
export class TileFactory {
    ...
    tile(a, b, c, d, vertices = this.vertices) {
        let pointsArray = [];
        let texCoordsArray = [];
    ...
    floor() {
        return this.tile(5, 3, 2, 6);
    }
    XYWall() {
        return this.tile(0, 1, 2, 3);
    }
    YZWall() {
        return this.tile(4, 0, 3, 5);
    }
...
export function tetrahedron(m, color) {
