class TextureHelper {
    ...
    configureTexture(image, ind, gl = this.gl, program = this.program) {
    ...
    configureCubeMap(gl = this.gl, program = this.program) {
    ...
    configureCubeMapImage(left, front, right, back, toppu, bottom, gl=this.gl, program=this.program) {
        let cubeMap = gl.createTexture();
